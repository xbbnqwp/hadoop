...
```Dockerfile
docker pull ekiras/hbase:hadoop-2.6.4-hbase-1.1.2
```

# Run Hbase docker container
Use the following command to run docker container
```Dockerfile
docker run -itd --name hbase -p50070:50070 -p8042:8042 -p8088:8088 -p16010:16010 -p9095:9095 -p8085:8085 -p2181:2181 ekiras/hbase:hadoop-2.6.4-hbase-1.1.2
```
